// https://algs4.cs.princeton.edu/code/edu/princeton/cs/algs4/SymbolGraph.java.html
...
public class SymbolGraph {
    ...
    private Graph graph;             // the graph with integer vertex names
    ...
    public int index(String s) {   return st.get(s);   }    // the integer associated with the vertex

    public String name(int v) {   return keys[v];   } // the name of the vertex associated with the integer

    public Graph G() {   return graph;   }  // the graph assoicated with the symbol graph
}
